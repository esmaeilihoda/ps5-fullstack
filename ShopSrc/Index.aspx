<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Shop.NIndex" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="row" style="font-family: 'B Titr'">
                        ...
                        <nav class="navbar navbar-dark navbar-expand-lg" style="float: right">
                            ...
                            <div class="collapse navbar-collapse" id="navbar">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li style="display: none" class="active"><a href="https://CHECKIT.ir/" class="nav-link">پنل پیامکی</a></li>
                                    <li><a href="http://CHECKITshop.com/Shop/index" class="nav-link">فروشگاه</a></li>
                  ...
                  <li><a href="blog-single.html" class="nav-link">Blog Sigle</a></li>-->
                            ...
                            <a class="navbar-brand" href="index.html">
                                <img src="img/CHECKITLOGO.png" style="height: 100px;" class="img-fluid" alt="logo"></a>
        ...
        <header class="bg-gradient" id="home">
            ...
            <div id="owl-demo" class="owl-carousel">
                ...
                <% Shop.Account.HomeManager HM = new Shop.Account.HomeManager();
         ...
         <div class="container mt-5" id="gallery1">
            <%--   <div class="container">--%>
            ...
            <div id="owl-demo11" class="img-gallery owl-carousel">
                ...
                <%--<% 
                    ...
                    {
                        int i = 0;
                        string[] sp = SDV[0]["BannerUrl"].ToString().Split("©".ToCharArray());
                        foreach (string sps in sp)
                        {
                            if (sps != "")
                            {
                ...
                %>--%>
                 <%Library.Model.EXEQ ME = new Library.Model.EXEQ();
                     ME.Q_Add("SELECT Number, head, contentt, FullContent  FROM  SiteContent WHERE TNews = 1 ");
                     System.Data.DataView SSDV = ME._GetDataView();
                     foreach(System.Data.DataRowView SDD in SSDV)
                     {
                         int i = 0;
                         if (i == 0)
                         {object @__o; %>
                               ...
                               <div class="item" style="color:white">
                                    <a target="_blank" style="width:100%;color:white;" href="SPages.aspx?CN=<%=SDD["Number"].ToString() %>" >
                               <%=SDD["contentt"].ToString() %>-
                                        </a>
                               </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6">
                        ...
                        <h2>خـدمات CHECKIT</h2>
                        <p class="mb-4">CHECKIT</p>
                ...
                <div class="row">
                    <div class="col-md-8 d-flex align-items-center">
                        <ul class="list-unstyled ui-steps">                            
                            <%
                                ME.Q_Add("SELECT Number, head, contentt, FullContent  FROM  SiteContent WHERE TNews <> 1 ");
                                SSDV = ME._GetDataView();
                                foreach(System.Data.DataRowView SDD in SSDV)
                                {object @__o; %>
                           
                              <li class="media" style="cursor:pointer;">
                                <a style="width:100%" href="SPages.aspx?CN=<%=SDD["Number"].ToString() %>" target="_blank">
                                <div style="float:right" class="circle-icon mr-4"><%=SDD["Number"].ToString() %></div>
                                <div class="media-body">
                                    <h5><%=SDD["head"].ToString() %></h5>
                                    <p><%=SDD["contentt"].ToString() %>.</p>
                                </div>
                                </a>  
                            </li>
        ...
        <div class="section bg-gradient">
            <div style="text-align: center" class="container">
                ...
                <img class="img-fluid" src="img/parvaneh.jpg" />
                <img class="img-fluid" src="img/sslct.png" />
                <img class="img-fluid" src="img/sherk.jpg" />--%>
                <div id="owl-demo2" class="img-gallery owl-carousel">
                    ...
                    <% 
                        ...
                        {
                            int i = 0;
                            string[] sp = SDV[0]["Certificats"].ToString().Split("©".ToCharArray());
                            foreach (string sps in sp)
                            {
                                if (sps != "")
                                {
                    ...
                    <div class="item">
                        <a href="<%=sps %>" target="_blank">
                            <img class="img-fluid" src="<%=sps %>" /></a>
                    </div>
                    <%  }
                        else
                        { %>
                ...
                <div style="background-color: rgb(204, 188, 88)">
                    <a target="_blank" href="https://trustseal.enamad.ir/?id=157847&amp;Code=qgnj29MvS4tNzOWqWhF6">
                        <img src="https://Trustseal.eNamad.ir/logo.aspx?id=157847&amp;Code=qgnj29MvS4tNzOWqWhF6" alt="" style="cursor: pointer; width: 156px; height: 156px; border-style: groove" id="qgnj29MvS4tNzOWqWhF6"></a>
                    <img id='jxlzjzpewlaofukzoeuknbqe' style='cursor: pointer; border-style: groove; width: 156px; height: 156px;' onclick='window.open("https://logo.samandehi.ir/Verify.aspx?id=174682&p=rfthjyoeaodsgvkamcsiuiwk", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt='logo-samandehi' src='https://logo.samandehi.ir/logo.aspx?id=174682&p=nbpdyndtshwlwlbqaqgwodrf' />

                    <img src="images/logokasb.png" alt="" onclick="window.open('https://ecunion.ir/verify/CHECKIT.ir?token=95355775f689bb634259', 'Popup','toolbar=no, location=no, statusbar=no, menubar=no, scrollbars=1, resizable=0, width=580, height=600, top=30')" style="cursor: pointer; border-style: groove; width: 156px; height: 156px;">
                    <img style="border-style: groove; width: 156px; height: 156px; cursor: pointer" src="img/otagh.png" onclick="window.open('img/parvaneh.jpg', 'Popup','toolbar=no, location=no, statusbar=no, menubar=no, scrollbars=1, resizable=0, width=580, height=600, top=30')" />
                </div>
        ...
        <div style="display: none" class="section" id="pricing">
            <div class="container">
                ...
                <div class="card-deck">
                    ...
                    <% Shop.Account.iindex naii = new Shop.Account.iindex();
                        ...
                        foreach (System.Data.DataRowView cdr in cdv)
                        {
                            ...
                            Library.MttApi ma = new Library.MttApi();
                            ma.getvalfromapi();
        ...
        <div style="display: none" class="section pt-0 sec-faq">
            <div class="container">
                ...
                <div class="row pt-4">
                    <div class="col-md-6">
                        <h4 class="mb-3">چرا باید در سایت CHECKIT ثبت نام کنم؟</h4>
                        <p class="light-font mb-5">CHECKIT</p>
        ...
        <div class="section bg-gradient" style="padding-top: 0px; padding-bottom: 20px">
            <div class="call-to-action" style="width: 98%; text-align: center; padding-right: 20px">
                ...
                <p class="tagline"></p>
                <div class="my-4">
                     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1679.9978214399755!2d51.713476958244584!3d32.632939495253936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fbc49868aa2f633%3A0x318c8464b04c8a28!2z2LTYsdqp2Kog2b7Yr9uM2K8g2KLZiNix2KfZhiDZgdqp2LEg2Ygg2KvYsdmI2Kog2KfYs9m-2KfYr9in2YY!5e0!3m2!1sen!2s!4v1611812345421!5m2!1sen!2s" frameborder="0" style="border: 4; height: 545px; width: 100%" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>    
                </div>
            </div>
            <%--</div>--%>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 text-center text-lg-right">
                        <p class="mb-2">
                            <span class="ti-location-pin mr-2"></span>استان اصفهان ، شهرستان اصفهان ، بخش مركزي ، شهر اصفهان، محله مهرآباد ، كوچه امين * ، كوچه شهيد عليخاني غربي [4] ، پلاك 52 ، پلاك قديمي471 ، طبقه اول کدپستی 8158987193

کد ثبت : 64448 شناسه ملی: 14009095542
                        </p>
                        <div class=" d-block d-sm-inline-block">
                            <p class="mb-2">
                                <span class="ti-email mr-2"></span><a class="mr-4" href="mailto:info@CHECKIT.ir" style="margin-right: 20px !important;">info@CHECKIT.ir</a>
                            </p>
                        </div>
                        <div class="d-block d-sm-inline-block">
                            <p class="mb-0">
                                <span class="ti-headphone-alt mr-2"></span><a href="tel:03132604453" style="margin-right: 20px !important;">031-3260-4453</a>
                            </p>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="social-icons">
                            <a href="https://t.me/CHECKITt "><span class="ti-plus"></span></a>
                            <a href="#"><span class="ti-twitter-alt"></span></a>
                            <a href="https://instagram.com/CHECKIT__net?igshid=d8ozwhl51mya"><span class="ti-instagram"></span></a>
                        </div>
                    </div>
                </div>
        ...
        <footer class="my-5 text-center">
            ...
            <p class="mb-2"><small>کپی رایت © 2020 کلیه ی حقوق محفوظ CHECKIT  </small></p>
