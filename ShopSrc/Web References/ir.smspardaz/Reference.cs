...
namespace Shop.ir.smspardaz {
    ...
    public partial class smsSendWebServiceforPHP : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public smsSendWebServiceforPHP() {
            this.Url = global::Shop.Properties.Settings.Default.NM_ir_smspardaz_www_smsSendWebServiceforPHP;
        ...
        public long[] SmsSend(string UserName, string Pass, string Domain, string[] SmsText, string[] MobileNumber, string SenderNumber) {
        ...
        /// <remarks/>
        public void SmsSendAsync(string UserName, string Pass, string Domain, string[] SmsText, string[] MobileNumber, string SenderNumber) {
            this.SmsSendAsync(UserName, Pass, Domain, SmsText, MobileNumber, SenderNumber, null);
        }
        
        /// <remarks/>
        public void SmsSendAsync(string UserName, string Pass, string Domain, string[] SmsText, string[] MobileNumber, string SenderNumber, object userState) {
            ...
            this.InvokeAsync("SmsSend", new object[] {
                        ...
                        SmsText,
                        MobileNumber,
                        SenderNumber}, this.SmsSendOperationCompleted, userState);
        }
