<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="MyAcc.aspx.cs" Inherits="Shop.Account.MyAcc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CCPH" runat="server" style="background-color:rgb(14 23 38);height:99vh">
    ...
    <script>
        $(function () {
            ...
            $("#CCPH_ShHesab").keyup(function () {

                var numbers = $.latin2Arabic.toLatin($(this).val());
                $(this).val(numbers);
                
            });
            $("#CCPH_HCardNumber").keyup(function () {

                var numbers = $.latin2Arabic.toLatin($(this).val());
                $(this).val(numbers);
                
            });
            $("#CCPH_shaba").keyup(function () {
