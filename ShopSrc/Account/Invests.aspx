<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="Invests.aspx.cs" Inherits="Shop.Account.Invests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CCPH" runat="server">
            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 runat="server" id="disnmae" class="page-title m-0">تراکنش های هبه در طرح های خدماتی و تولیدی شرکت</h4>
                        </div>
    ...
    <asp:UpdatePanel runat="server" ID="UP">
            ...
            <div class="row">
                <div class="col-xl-9">
                    ...
                    <div class="col-md-12" style="text-align:-webkit-center;">
                            <div class="col-md-4" style="background-color:black;display: grid;text-align: center;border-style: dotted;border-color: white;">
                                <h5 runat="server" id="H1" class="page-title m-3" style="color:white">معرف 1</h5>
                            </div><hr style="color:coral;font-size:10px" />
                     </div>
                     <telerik:RadGrid AllowPaging="true" PageSize="20" ClientSettings-AllowKeyboardNavigation="true"
                        ID="InvA_Grid" runat="server" AutoGenerateColumns="False" Skin="Metro"
                        GroupPanelPosition="Top" Font-Names="BK" Font-Overline="False"
                    ...
                    <hr />
                     ...
                     <telerik:RadGrid AllowPaging="true" PageSize="20" ClientSettings-AllowKeyboardNavigation="true"
                        ID="InvB_Grid" runat="server" AutoGenerateColumns="False" Skin="Telerik"
                        GroupPanelPosition="Top" Font-Names="BK" Font-Overline="False"
     ...
     <div class="col-md-12" style="text-align:-webkit-center;">
                            <div class="col-md-4" style="background-color: rgb(60, 164, 28);display: grid;text-align: center;border-style: dotted;border-color: white;">
                                <h5 runat="server" id="HMah" class="page-title m-3" style="color:white">Level 2</h5>
                            </div><hr style="color:coral;font-size:10px" />
                    <div class="col-md-4" style="background-color: rgba(64, 180, 28, 0.98);display: grid;text-align: center;border-style: dotted;border-color: white;">
                    ...
                    <div class="col-md-12" style="text-align:-webkit-center;">
                     ...
                     <telerik:RadGrid AllowPaging="true" PageSize="20" ClientSettings-AllowKeyboardNavigation="true"
                        ID="HebeDetail" runat="server" AutoGenerateColumns="False" Skin="Metro"
                        GroupPanelPosition="Top" Font-Names="BK" Font-Overline="False"
                    ...
                    <hr />
                         <div class="col-md-12" style="text-align:-webkit-center;">
                            <div class="col-md-4" style="background-color: rgba(212, 19, 19, 0.83);display: grid;text-align: center;border-style: dotted;border-color: white;">
                                <h5 runat="server" id="SUMMT" class="page-title m-3" style="color:white">Level 2</h5>
                            </div><hr style="color:coral;font-size:10px" />
                    <div class="col-md-4" style="background-color: rgba(241, 30, 30, 0.83);display: grid;text-align: center;border-style: dotted;border-color: white;">
                                <h5 runat="server" id="Payed" class="page-title m-3" style="color:white">Level 2</h5>
                    </div><hr style="color:coral;font-size:10px" />
                              <div class="col-md-4" style="background-color: rgba(241, 30, 30, 0.69);display: grid;text-align: center;border-style: dotted;border-color: white;">
