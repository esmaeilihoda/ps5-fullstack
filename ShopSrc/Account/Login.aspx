<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Shop.Account.Login" %>
...
<head>
    ...
    <script src="../Scripts/WeCan_LIB.js"></script>
    <script>
       // alert(urlparms['ComeBack']);
        function reg_click() {
            window.location = "register.aspx?ComeBack=" + urlparms['ComeBack'];
        }
    </script>
  <meta charset="utf-8">
...
<%--  <asp:UpdatePanel runat="server" ID="UP"><ContentTemplate>--%>
    <div class="row justify-content-center">
        <%--<asp:UpdatePanel runat="server" ID="omjUpd"><ContentTemplate>--%>
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row" style="background-color:snow;">
              ...
              <div class="col-lg-6">
                <div class="p-5" style="background-color:snow;border-color:#20aedc;border-radius:25px;border-style:solid">
                  <div class="text-center">
                    <h1 class="h4 mb-4 text-danger">خوش آمدید</h1>
                  </div>
 ...
 <%--   <telerik:RadFormDecorator RenderMode="Lightweight" ID="FormDecorator1" runat="server" DecoratedControls="All" DecorationZoneID="zoneToDecorate">
    ...
    <div class="demo-container text-right" id="zoneToDecorate">
        <telerik:RadCaptcha ID="RadCaptcha1" runat="server" ValidationGroup="Group" Width="162" Style="float:left"
        ...
        <div style="float:left;margin-top: 58px;"><a href="Login.aspx"><img src="../img/loading.gif" /></a></div>
        ...
        <div style="margin-top: 15px;">
            <asp:Button CssClass="btn btn-primary btn-user btn-block" ID="btnValidate" runat="server" Text="ورود" ValidationGroup="Group">
                    ...
                    <hr>
                    <a href="#" class="btn btn-google btn-user btn-block" style="display:none">
                      <i class="fab fa-fantasy-flight-games fa-fw"></i> رمز عبور خود را فراموش کرده اید؟
                    </a>
                    <a href="../index.aspx" class="btn btn-dark btn-user btn-block">
                      <i class="fab fa-apple"></i> برگشت به صفحه اصلی
                    </a>
                     <a onclick="reg_click();"  class="btn btn-info btn-user btn-block" >
                      <i class="fab fa-readme"></i> ثبت نام
                    </a>
                  <hr>
                 <%-- <div class="text-center">
