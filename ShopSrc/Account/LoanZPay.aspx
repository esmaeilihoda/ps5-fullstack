<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="LoanZPay.aspx.cs" Inherits="Shop.Account.LoanZPay" %>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">پرداخت کارمزد وام!</h1>
                  <hr />
              </div>        
