<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="Verify.aspx.cs" Inherits="Shop.Account.Verify" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CCPH" runat="server">
        <div class="card o-hidden border-0 shadow-lg my-5" style="height:98vh">
      <div class="card-body p-0" style="background-color:rgb(14 23 38);border-radius:25px;border-style:double;border-color:red">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4 text-danger">تایید شماره تلفن همراه</h1>
                  <hr />
              </div>        
            ...
            <div style="display:none" class="form-group row">
                ...
                <div  class="form-group row">
                            <label for="Shopobile" class="col-form-label-sm" >تغییر شماره موبایل</label>
                            <input name="Shopobile" type="text" runat="server" class="form-control form-control-user"
                               id="Shopobile" placeholder="تغییر شماره تلفن" />
                </div>
                <div  class="form-group row">                        
