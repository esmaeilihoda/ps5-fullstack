<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="Shop.Account.EditProfile" %>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">اصلاح اطلاعات کاربری!</h1>
                  <hr />
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="companysign" class="col-form-label-sm" >استفاده از امضای شرکت</label>
                            <input name="companysign" type="text" runat="server" class="form-control form-control-user"
...
<%--                    <div class="form-group row">
            ...
            <div class="form-group row">
                            <label for="BirthDate" class="col-form-label-sm" >تاریخ تولد</label>
                            <telerik:RadMaskedTextBox runat="server" Mask="####/##/##" ID="BirthDate" class="form-control form-control-user" >
