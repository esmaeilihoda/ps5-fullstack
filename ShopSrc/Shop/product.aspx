<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/ShopMain.Master" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="Shop.Shop.product" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="befSlideBox" runat="server">       
    ...
    <ContentTemplate>
     ...
     <% Shop.Shop.ShopMain SSM = new Shop.Shop.ShopMain();
         string pid = "";
