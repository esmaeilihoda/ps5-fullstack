<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/ShopMain.Master" AutoEventWireup="true" CodeBehind="fullproducts.aspx.cs" Inherits="Shop.Shop.fullproducts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="befSlideBox" runat="server">
    ...
    <div class="col-lg-10 col-md-12  h-100 ">
        <div class="row" style="width: 98%; margin-right: 1%; margin-left: 1%;">
            <% Shop.Shop.ShopMain NSS = new Shop.Shop.ShopMain();
