...
{
    public partial class ShopPGroups : System.Web.UI.Page
    {
        ...
        {          
            ...
            if (IId.Value.Trim() == "")
            {
                ME.Q_Add(@"INSERT INTO Shop_PGroups
            ...
            {
                ME.Q_Add(@"UPDATE Shop_PGroups SET
        ...
        {
            ME.Q_Add("SELECT * FROM Shop_PGroups");
        ...
        protected void Shop_ListItemsGrd_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == "ListEdit")
            {
                ...
                ME.Q_Add("SELECT * FROM Shop_PGroups WHERE Id = @Id ");
