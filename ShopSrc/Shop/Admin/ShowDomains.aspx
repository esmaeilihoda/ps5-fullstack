<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/Admin/SAM.Master" AutoEventWireup="true" CodeBehind="ShowDomains.aspx.cs" Inherits="Shop.Shop.Admin.ShowDomains" %>
                                        ...
                                        <MasterTableView AllowFilteringByColumn="true">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="DRmobile" FilterControlAltText="Filter TemplateColumn column" HeaderText="تلفن همراه"
                                                 ...
                                                 <telerik:GridBoundColumn DataField="Status" FilterControlAltText="Filter TemplateColumn column" HeaderText="وضعیت"
                                                    UniqueName="Status">
                                                    <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                                                    <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                  <telerik:GridButtonColumn CommandName="ChangeStatus" DataTextField="Status" FilterControlAltText="Filter TemplateColumn column" HeaderText="تغییر وضعیت"
                                                    UniqueName="Status">
                                                    <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                                                    <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
