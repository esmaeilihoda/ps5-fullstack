...
<head runat="server">
	...
	<title>CHECKIT One Page HTML Template</title>
	<!-- Meta Description -->
		...
		<div class="container">
			<div class="navbar-header">
				...
				<h1 class="navbar-brand">
					<a href="#body">ESP</a>
					<img src="img/CHECKITLOGO.png" class="wslogo" style="height:150px;width:150px;" />
				</h1>
				<!-- /logo -->
			</div>
				...
				<div class="footer-content">
					...
					<div class="footer-social">
						<ul>
							...
							<li class="wow animated zoomIn" data-wow-delay="0.3s"><a href="https://instagram.com/CHECKIT__net?igshid=d8ozwhl51mya"><i class="fa fa-instagram fa-3x"></i></a>
							</li>
							<li class="wow animated zoomIn" data-wow-delay="0.6s"><a href="https://t.me/CHECKITt"><i class="fa fa-telegram fa-3x"></i></a>
							</li>
					...
					<p>Copyright &copy; 2020<a href="#">CHECKIT</a> </p>
				</div>
			</div>
		</div>
	</footer>
