<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="temp.aspx.cs" Inherits="NM.Account.Home" %>
...
<body id="body" dir="rtl">
	...
	<main class="site-content" role="main">
        ...
        <telerik:RadImageGallery  ImagesFolderPath="img/slider" LoopItems="true" RenderMode="Mobile" DisplayAreaMode="Image"
            ID="RadImageGallery1" EnableAjaxSkinRendering="true"  ItemType="Telerik.Charting.Chart" runat="server"></telerik:RadImageGallery>
			...
			<div class="overlay">
				<div class="container">
					<div class="row">
						...
						<div style="height:500px" class="sec-title text-center white wow animated fadeInDown">
									<section id="home-slider" style="height:500px">
