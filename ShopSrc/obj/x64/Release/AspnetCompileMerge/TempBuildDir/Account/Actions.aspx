<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="Actions.aspx.cs" Inherits="NM.Account.Actions" %>
                                    ...
                                    <div class="page-title-box">
                                        <div class="row align-items-center">
                                            <div class="col-md-8" style="text-align:center">
                                                <div runat="server" id="disnmae" class="page-title m-0 text-white" style="text-align:center"> تراکنش</div>
                                            </div>
                                            <div class="col-md-4">
...
<asp:UpdatePanel runat="server" ID="UP"><ContentTemplate>
         <div class="row" style="height:99vh">
             <div class="col-xl-9">        
          <telerik:RadGrid AllowPaging="true" EnableEmbeddedSkins="true" PageSize="20" ClientSettings-AllowKeyboardNavigation="true" 
           ID="Marketers_Grid" runat="server" AutoGenerateColumns="False" GroupPanelPosition="Top" Font-Names="BK" Font-Overline="False" 
            OnNeedDataSource="Marketers_Grid_NeedDataSource" Skin="WebBlue" OnItemCommand="Marketers_Grid_ItemCommand"
           ...
           BorderStyle="Inset" AllowSorting="True">
                ...
                <MasterTableView>
                    <Columns>
                        <telerik:GridBoundColumn DataField="PDat" DataFormatString="{0:####/##/##}" FilterControlAltText="Filter TemplateColumn column" HeaderText="تاریخ" UniqueName="PDat">
                            <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                            <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ActionName" FilterControlAltText="Filter TemplateColumn column" HeaderText="شرح عملیات" UniqueName="ActionName">
                            <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                            <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>
                        <telerik:GridNumericColumn DataField="Variz" FilterControlAltText="Filter column3 column" HeaderText="واریز" UniqueName="Variz">
                        ...
                        <telerik:GridNumericColumn DataField="Bardasht" FilterControlAltText="Filter column3 column" HeaderText="برداشت" UniqueName="Bardasht">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridNumericColumn>
                    </Columns>
