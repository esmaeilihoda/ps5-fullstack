<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="MyTeamDiagram.aspx.cs" Inherits="NM.Account.MyTeamDiagram" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CCPH" runat="server">
    ...
    <div style="direction:ltr;overflow:scroll">
        <telerik:RadDiagram BackColor="#373737"  ID="theDiagram" EnableAjaxSkinRendering="true"
            Editable="false" Height="4000" Width="4000" runat="server" >
