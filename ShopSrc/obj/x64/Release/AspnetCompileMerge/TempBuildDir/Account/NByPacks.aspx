<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="NByPacks.aspx.cs" Inherits="NM.Account.NByPacks" %>
    ...
    <asp:ScriptManager runat="server" ID="SMH">
      ...
      <div id="content">
              ...
              <div class="card shadow mb-4" style="background-color:rgb(0 0 0)">
                  ...
                  <div style="font-size:x-large;color:red;stroke:white;text-align:center">فعال کردن پک های درآمدزایی </div>
                        ...
                        <a runat="server" visible="false" id="ffa" class="btn btn-danger btn-icon-split">
                              ...
                              <div class="row">
                                  ...
                                  <asp:RadioButtonList ForeColor="White" OnSelectedIndexChanged="packtype_SelectedIndexChanged" AutoPostBack="true"
                                      ...
                                      <asp:ListItem Selected="True" Text="پک های پیش فرض" Value="0"></asp:ListItem>
                                      <asp:ListItem Text="پک انتخابی" Value="1">
                                      </asp:ListItem>
                                  </asp:RadioButtonList>
                                  ...
                                  <div class="row">
                                      <asp:DropDownList style="display:none" CssClass="dropdown" OnSelectedIndexChanged="PackNo_SelectedIndexChanged"
                                  ...
                                  <div class="row">
                                      <telerik:RadGrid Width="100%" ClientSettings-AllowKeyboardNavigation="true" Skin="Black"
                                          ...
                                          <MasterTableView>
                                              <Columns>
                                                  ...
                                                  <telerik:GridTemplateColumn AllowFiltering="false"
                                                      DataField="CHK" FilterControlAltText="Filter column3 column" HeaderText="نصویر" UniqueName="packimg">
                                                      <ItemTemplate>
                                      ...
                                      <br />
                                        <asp:DropDownList style="width: 100%;
                                            ...
                                            border-radius: 10px;" runat="server" ID="PayType">
                                      ...
                                      <br /><br /><hr style="color:forestgreen;height:5px" />
                                        <asp:Label ID="PackLbl" runat="server"
                                              style="width: 100%;
                                            background-color: darkorange;
                                            border-radius: 5px;" CssClass="alert-dark"></asp:Label>
                                      <asp:RadioButtonList ForeColor="White" AutoPostBack="true" OnSelectedIndexChanged="sendmode_SelectedIndexChanged" runat="server" ID="sendmode" >
                                          <asp:ListItem Text="ارسال به آدرس پستی" Value="0"></asp:ListItem>
                                          <asp:ListItem Text="دریافت از انبار شرکت" Value="1"></asp:ListItem>
                                      </asp:RadioButtonList>                                      
                                      <asp:TextBox Enabled="false" Width="100%" Visible="false" runat="server" ID="sendaddress"></asp:TextBox>
                                  </div>
