<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="ActiveTurbo.aspx.cs" Inherits="NM.Account.ActiveTurbo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CCPH" runat="server">
    ...
    <asp:ScriptManager runat="server" ID="SMH">
      ...
      <div id="content" style="height:99vh">
          <br /><br /><br />
                <div class="col-lg-4" style="min-width:50%">
              <!-- Background Gradient Utilities -->
              <div class="card shadow mb-4" style="background-color:rgb(14 23 38);margin-bottom:10px;border-color:red;border-style: double;border-radius:25px">
                ...
                <div class="card-body">
                  ...
                  <asp:HiddenField runat="server" ID="PNO" ClientIDMode="Static" />
                    <div class="row">
                        ...
                        <div runat="server" onclick="alarmclick();" style="font-size:40px" id="alarm" class="btn-danger"></div>
                     </div>
                     <div class="row">
                        <div runat="server" id="DivPay" class="col-xl-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <asp:Button runat="server" OnClick="ByPack_Click" ID="Register" OnClientClick="document.forms[0].target = '_blank';" class="btn btn-primary btn-user btn-block" Text="فعال سازی پک توربو" />
                </div>
                </div>
                </div>
     </div>
