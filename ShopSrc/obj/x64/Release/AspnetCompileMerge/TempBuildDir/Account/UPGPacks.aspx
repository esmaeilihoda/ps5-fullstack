...
<asp:Content ID="Content1" ContentPlaceHolderID="CCPH" runat="server">
    ...
    <asp:ScriptManager runat="server" ID="SMH">
      ...
      <div id="content" style="background-color:black;height:99vh">
          <br /><br /><br />
                <div class="col-lg-4" style="min-width:50%">
              <!-- Background Gradient Utilities -->
              <div class="card shadow mb-4" style="background-color:rgb(14 23 38);border-color:red;border-radius:25px;border-style:double">
                <div  style="text-align:center">
                  <h6 class="m-0 font-weight-bold text-danger" style="font-size:x-large">ارتقا جایگاه</h6>
                </div>
                <div class="card-body">
