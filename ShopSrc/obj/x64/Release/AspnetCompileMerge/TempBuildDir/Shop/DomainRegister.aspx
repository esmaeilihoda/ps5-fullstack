<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/ShopMain.Master" AutoEventWireup="true" CodeBehind="DomainRegister.aspx.cs" Inherits="NM.Shop.DomainRegister" %>
                    ...
                    <div class="col-12">
                        <div class="row" style="direction: ltr">
                            <div class="col-md-6 col-12 mr-md-0 pr-md-0">
                                ...
                                <input type="text" class="form-control" placeholder="نام دامنه را وارد نمایید مثال: espadan" id="DRsubdomain" runat="server" />
                            </div>
                            <div class="col-md-3 col-12 ml-md-0 pl-md-0 mr-md-0 pr-md-0">
                                <select class="form-control" id="DRdomain" runat="server">
                                    <option value="espadanshop">espadanshop</option>
                                </select>
