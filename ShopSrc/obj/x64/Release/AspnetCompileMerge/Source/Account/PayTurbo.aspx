<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="PayTurbo.aspx.cs" Inherits="NM.Account.PayTurbo" %>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">نتیجه خرید پک توربو!</h1>
                  <hr />
              </div>        
