<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/ShopMain.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="NM.Shop.index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="befSlideBox" runat="server">
</asp:Content>
<asp:Content ID="AftSlideBox" ContentPlaceHolderID="AftSlideBox" runat="server">
    <div runat="server" id="AS">
