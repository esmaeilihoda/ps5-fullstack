<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="NM.Account.Register" %>
...
<head>
  ...
  <title>ثبت نام در اسپادان</title>
...
مسئولیت صحت اطلاعات وارده بر اساس شناسنامه و کارت ملی در فرم ثبت نام به عهده شخص متقاضی ثبت نام بوده وشرکت اسپادان هیچگونه مسئولیتی نسبت به ورود اطلاعات غلط و ناقص نخواهد داشت.
-کلیه مبالغ پرداختی توسط مشریان در قبال دریافت کالا / خدمات دریافتی می باشد.
- در صورتیکه پس از واریز وجه، خریدار از خرید منصرف گردد، در قوانین باشگاه آمده است اجازه لغو سفارش فقط تا 48 ساعت می باشد .
