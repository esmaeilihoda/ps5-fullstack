<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="NM.Account.Details" %>
                                    ...
                                    <div class="page-title-box" style="text-align:center">
                                        <div class="row align-items-center" style="text-align:center">
                                            <div class="col-md-8" style="text-align:center">
                                                <div style="color:red;text-align:center" runat="server" id="disnmae" class="page-title m-0">جزئیات درآمدها</div>
                                            </div>
...
<asp:UpdatePanel runat="server" ID="UP"><ContentTemplate>
  ...
  <telerik:RadGrid AllowPaging="true" PageSize="20" ClientSettings-AllowKeyboardNavigation="true" 
           ID="Marketers_Grid" runat="server" AutoGenerateColumns="False" GroupPanelPosition="Top" Font-Names="BK" Font-Overline="False" 
            OnNeedDataSource="Marketers_Grid_NeedDataSource" OnItemCommand="Marketers_Grid_ItemCommand" Skin="WebBlue"
           BorderStyle="Inset" AllowSorting="True">
                ...
                <MasterTableView>
                    <Columns>
                        <telerik:GridBoundColumn DataField="R" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlAltText="Filter TemplateColumn column" HeaderText="ورودی راست" UniqueName="R">
                            <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                            <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>
                        <telerik:GridNumericColumn DataField="L" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlAltText="Filter column3 column" HeaderText="ورودی چپ" UniqueName="L">
                        ...
                        <telerik:GridBoundColumn FilterControlAltText="Filter column9 column" CurrentFilterFunction="Contains" ShowFilterIcon="false" HeaderText="تعادل" UniqueName="P" DataField="P" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridBoundColumn>
                        
                        <telerik:GridBoundColumn FilterControlAltText="Filter column9 column" CurrentFilterFunction="Contains"
                             ShowFilterIcon="false" HeaderText="ج.ت" UniqueName="SP" DataField="SP" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridBoundColumn>
                        
                        <telerik:GridBoundColumn FilterControlAltText="Filter column9 column" CurrentFilterFunction="Contains"
                             ShowFilterIcon="false" HeaderText="پ" UniqueName="DayP" DataField="DayP" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                        ...
                        <telerik:GridBoundColumn FilterControlAltText="Filter column9 column" CurrentFilterFunction="Contains"
                             ShowFilterIcon="false" HeaderText="ج.پ" UniqueName="SUMP" DataField="SUMP" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridBoundColumn>
                        
                        <telerik:GridBoundColumn DataFormatString="{0:####/##/##}" FilterControlAltText="Filter column9 column" CurrentFilterFunction="Contains"
                             ShowFilterIcon="false" HeaderText="تاریخ" UniqueName="Date" DataField="Date" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium"
                                 HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridBoundColumn>
