...
<asp:Content ID="Content2" ContentPlaceHolderID="CCPH" runat="server">
	...
	font-family: 'IRANSans';
	src: 
	url('../Fonts/IRANSansoodakBold.ttf') 
	format('opentype');
}
    </style>
    <asp:ScriptManager runat="server" ID="SMR">
          <Services>
                                ...
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">تعداد کل اعضای باشگاه مشتریان</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">30603نفر</div>
                                                </div>
                                                <div class="col-auto">
                                                    <i class="fas fa-calendar fa-2x text-gray-300" style="color:orangered"></i>
                                                </div>
     ...
     <telerik:RadGrid AllowPaging="true" PageSize="20" ClientSettings-AllowKeyboardNavigation="true" 
           ID="Marketers_Grid" runat="server" AutoGenerateColumns="False" GroupPanelPosition="Top" Font-Names="IRANSans" Font-Overline="False" 
                ...
                <MasterTableView>
                    <Columns>
                        <telerik:GridBoundColumn DataField="UserName" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlAltText="Filter TemplateColumn column" HeaderText="نام کاربری" UniqueName="UserName">
                            ...
                            <ItemStyle BorderStyle="Outset" Font-Names="IRANSans" Font-Size="Small"  HorizontalAlign="Center" />
