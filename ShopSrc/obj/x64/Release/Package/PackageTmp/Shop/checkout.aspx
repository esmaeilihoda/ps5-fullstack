...
<asp:Content ID="Content1" ContentPlaceHolderID="befSlideBox" runat="server">
    ...
    <script type="text/javascript">
        function deletfromcartItem(id) {
            NM.Shop.Admin.ShopAdmin.Set_Get_BI("delete", "bascket-item", id, Set_Get_BI_SC00_cart, WAError);
        }
        function AddfromcartItem(id) {
            NM.Shop.Admin.ShopAdmin.Set_Get_BI("Add", "bascket-item", id, Set_Get_BI_SC00_cart, WAError);
        }
        ...
        function chekout() {
            NM.Shop.Admin.ShopAdmin.CheckOut(chres, WAError);
        }
        function chres(r) {
            if (r[0] == "ok")
                window.open(r[1]);
