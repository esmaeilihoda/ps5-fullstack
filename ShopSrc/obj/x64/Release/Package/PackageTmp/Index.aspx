                        ...
                        <nav class="navbar navbar-dark navbar-expand-lg" style="float: right">
                            ...
                            <div class="collapse navbar-collapse" id="navbar">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li><a href="http://espadanshop.com/Shop/index" class="nav-link">فروشگاه</a></li>
        ...
        <div class="section bg-gradient">
            <div style="text-align: center" class="container">
                ...
                <div style="background-color: rgb(204, 188, 88)">
                    ...
                    <img src="images/logokasb.png" alt="" onclick="window.open('https://ecunion.ir/verify/espadannet.ir?token=95355775f689bb634259', 'Popup','toolbar=no, location=no, statusbar=no, menubar=no, scrollbars=1, resizable=0, width=580, height=600, top=30')" style="cursor: pointer; border-style: groove; width: 156px; height: 156px;">
