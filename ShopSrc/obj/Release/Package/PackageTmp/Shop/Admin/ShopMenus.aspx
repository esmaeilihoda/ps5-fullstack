<%@ Page Title="" Language="C#" MasterPageFile="~/Shop/Admin/SAM.Master" AutoEventWireup="true" CodeBehind="ShopMenus.aspx.cs" Inherits="NM.Shop.Admin.ShopMenus" %>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <script type="text/javascript">
                                    function rr() {
                                        NM.Shop.Admin.ShopAdmin.HW("", WASucsess, WAError);
                                        return false;
                                        //alert(Ajax_Wecan(data, url));
                                    };
