                        ...
                        <div class="col-lg-5 mb-all-40">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="thumb0" class="tab-pane fade show active">
                                   ...
                                   <%int cd = 10; foreach (string gpi in gpics)
                                       { if (gpi != "")
                                           { %>
                                <div id="thumb<%=cd%>" class="tab-pane fade">
                                    <a data-fancybox="images" href="<%=gpi %>"><img src="<%=gpi %>" alt="product-view"></a>
                                </div>
                                <% }
                                                   cd++; } %>                                
                            </div>
                            ...
                            <div class="product-thumbnail mt-15">
                                <div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
                                    ...
                                    <a class="active" data-toggle="tab" href="#thumb1"><img src="<%=SDDR["ImageUrl"].ToString() %>" alt="product-thumbnail"></a>
                                    <%int cd0 = 10; foreach (string gpi in gpics)
                                        { if (gpi != "")
                                            { %>
                                    <a data-toggle="tab" href="#thumb<%=cd0 %>"><img src="<%=gpi %>"" alt="product-thumbnail"></a>
                                    <%
                                                    } cd0++; } %>
                                </div>
                            </div>
                            ...
                            <div class="thubnail-desc fix">
                                ...
                                <div class="pro-price mtb-30">
                                    <p class="d-flex align-items-center"><span class="prev-price"><%=SDDR["Price"].ToString() %> تومان</span>
                                        <%if (SDDR["VPrice"].ToString() != "0")
                                            { %>
                                        <span class="price"><%=SDDR["VPrice"].ToString() %> تومان</span><span class="saving-price">تخفیف <%=SDDR["Disc"].ToString() %>%</span></p>
                                    <%} %>
                                </div>
                                ...
                                <div style="display:none" class="product-size mb-20 clearfix">
                                 ...
                                 <%-- hided by programer --%>
                                <div style="display:none" class="color clearfix mb-20">
                                    <label>رنگ</label>
                                    <ul class="color-list">
                                        <li>
                                ...
                                <div class="box-quantity d-flex hot-product2">
                                    <form action="#">
                                        <input class="quantity ml-15" type="number" min="1" value="1">
                                    </form>
                                    <div class="pro-actions">
                                        <div class="actions-primary">
                                            <a href="javascript:addtocart(<%= SDDR["PId"].ToString() %>);" title="" data-original-title="افزودن به سبد خرید"> اضافه کردن به سبد خرید</a>
                                        </div>
