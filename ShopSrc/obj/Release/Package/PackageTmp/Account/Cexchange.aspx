<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="Cexchange.aspx.cs" Inherits="NM.Account.Cexchanege" %>
            ...
            <div  style="display:none" class="form-group row">
                 ...
                 <div runat="server" id="coinsprice" class="row">
                    ...
                    <div class="form-group row">                        
                            <label for="PayKif" class="col-form-label-sm" >تبادل از کیف پول</label>
                            <asp:DropDownList CssClass="dropdown" OnSelectedIndexChanged="PayKif_SelectedIndexChanged"
                                        ...
                                        <asp:ListItem Value="1" Text="کیف پول اصلی"></asp:ListItem>
                ...
                <div class="form-group row">
                            ...
                            <input name="TContent" type="number" runat="server" onchange="document.getElementById('amtchanege').click();"
                    ...
                    <div class="form-group row">                        
                            <label for="CoinsList" class="col-form-label-sm" >تبدیل به ارز</label>
