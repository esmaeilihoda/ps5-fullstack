<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="PayReqs.aspx.cs" Inherits="NM.Account.PayReqs" %>
                                                ...
                                                <div class="float-right d-md-block">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
                                                            <a class="dropdown-item" href="PayReqs.aspx?mode=0">فقط درخواست های واریز نشده</a>
                                                            <a class="dropdown-item" href="PayReqs.aspx?mode=1">فقط درخواست های واریز شده</a>   
                                                            <asp:Button runat="server" ID="exporttoexcel" OnClick="exporttoexcel_Click" Text="آماده سازی برای خروجیها" />
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item" href="PayReqs.aspx">همه</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<asp:UpdatePanel runat="server" ID="UP"><ContentTemplate>
         <div class="row">
             <div class="col-xl-9"> 
                 <asp:CheckBox runat="server" ID="SendSms" Text="SMS" />       
           ...
           BorderStyle="Inset" AllowSorting="True">
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="MID" FilterControlAltText="Filter TemplateColumn column" HeaderText="کد کاربری" UniqueName="MID">
                            <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                            <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="UName" FilterControlAltText="Filter TemplateColumn column" HeaderText="نام کاربری" UniqueName="UName">
                            <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                            <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>
                        
                        <telerik:GridBoundColumn DataField="ShHesab" FilterControlAltText="Filter TemplateColumn column" HeaderText="شماره حساب" UniqueName="ShHesab">
                            <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                            <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn DataField="Mobile" FilterControlAltText="Filter TemplateColumn column" HeaderText="شماره تلفن" UniqueName="Mobile">
                            <HeaderStyle Font-Names="BK" HorizontalAlign="Center" />
                            <ItemStyle BorderStyle="Outset" Font-Names="BK" HorizontalAlign="Center" />
                        </telerik:GridBoundColumn>
                        <telerik:GridNumericColumn DataField="ReqPay" FilterControlAltText="Filter column3 column" HeaderText="مبلغ درخواستی" UniqueName="ReqPay">
                        ...
                        <telerik:GridNumericColumn DataField="Loan" FilterControlAltText="Filter column3 column" HeaderText="وام" UniqueName="Loan">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridNumericColumn>
                        <telerik:GridNumericColumn DataField="ReqDate" FilterControlAltText="Filter column3 column" HeaderText="تاریخ درخواست" UniqueName="ReqDate">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridNumericColumn>
                        <telerik:GridNumericColumn DataField="PStatus" FilterControlAltText="Filter column3 column" HeaderText="وضعیت" UniqueName="PStatus">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridNumericColumn>
