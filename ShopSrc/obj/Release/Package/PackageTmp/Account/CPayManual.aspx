<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="CPayManual.aspx.cs" Inherits="NM.Account.CPayManual" %>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">ارتقا جایگاه دستی!</h1>
                  <hr />
              </div>        
