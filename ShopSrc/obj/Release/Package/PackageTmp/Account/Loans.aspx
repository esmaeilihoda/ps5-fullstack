<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="Loans.aspx.cs" Inherits="NM.Account.Loans" %>
         ...
         <div class="row">
           ...
           BorderStyle="Inset" AllowSorting="True">
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridButtonColumn CommandName="FillLOAN" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlAltText="Filter column9 column" HeaderText="وام" UniqueName="LOAN" DataTextField="TLoans" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridButtonColumn>
                        <telerik:GridButtonColumn CommandName="Delete" FilterControlAltText="Filter column9 column" HeaderText="حذف"
                             ConfirmText="آیا برای حذف مطمئن هستید؟!!!"                          
          ...
          <div class="row">    
             <div runat="server" id="dvloan" class="col-xl-9">  
               <telerik:RadGrid ClientSettings-AllowKeyboardNavigation="true" OnItemCommand="LOANGRID_ItemCommand"
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Loan" FilterControlAltText="Filter TemplateColumn column" HeaderText="نام کاربری" UniqueName="UserName">
                         ...
                         <telerik:GridButtonColumn CommandName="Delete" FilterControlAltText="Filter column9 column" HeaderText="حذف"
                             ConfirmText="آیا برای حذف وام مطمئن هستید؟!!!"                          
                             UniqueName="CD_DL" DataTextField="CD_DL" HeaderTooltip="حذف وام">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridButtonColumn>
                    </Columns>
