      ...
      <div id="content">
              ...
              <div class="card shadow mb-4" style="background-color:rgb(0 0 0)">
                ...
                <div class="card-body">
                  ...
                  <div onclick="packclick(2)" style="background-color:rgb(14 23 38);margin-bottom:10px;border-color:red;border-style: double;"
                  ...
                  <div onclick="packclick(4)" style="background-color:rgb(14 23 38);margin-bottom:10px;border-color:red;border-style: double;"
                       class="px-3 py-5 bg-gradient-info text-white">
                  ...
                  <div onclick="packclick(6)" style="background-color:rgb(14 23 38);margin-bottom:10px;border-color:red;border-style: double;"
                       class="px-3 py-5 bg-gradient-warning text-white">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <asp:DropDownList CssClass="dropdown" runat="server" ID="PayType">
                                        ...
                                        <asp:ListItem Value="6" Enabled="false" Text="MTT"></asp:ListItem>
