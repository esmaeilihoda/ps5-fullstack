            ...
            <div class="row">
                ...
                <% NM.Account.iindex naii = new NM.Account.iindex();
                    ...
                    foreach (System.Data.DataRowView cdr in cdv)
                    {
                        ...
                        if (cdr["sample"].ToString() == "MTT")
                        {

                            double coinoutpr = coinm[1] / coinm[0] * 100;
                            double coinppres = coinm[2] / coinm[0] * 100;


                %>
                <div class="col-xl-9 col-md-6" style="max-height: -webkit-fill-available; text-align: -webkit-center;">
                    <div class="card border-left-primary shadow h-100 py-2" style="max-height: -webkit-fill-available; text-align: center">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2" style="padding-right: 20px;">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800" style="padding-top: 10px"><%=cdr["PriceUSD"].ToString() + "$" %></div>
                            </div>
                        ...
                        <%--<div style="display:block; width:100%;text-align:center;text-align: -webkit-center;margin-top: 40px;">--%>
                        <br />
                        <br />
                        <div style="text-align: -webkit-center; width: 100%">
                            <div style="display: block; width: 90%;">
                                <div class="progress m-b-10" style="height: 30px">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: 100%; height: 100%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">IN <%=coinm[0] %></div>
                                </div>
                                <div class="progress m-b-10" style="height: 30px">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: <%= coinoutpr  %>%; height: 100%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">OUT<%= "-" + coinm[1]  %></div>
                                </div>
                                <div class="progress m-b-10" style="height: 30px; background-color: #3b3bc4">
                                    <div class="progress-bar bg-dark" role="progressbar" style="width: <%= coinppres  %>%; height: 100%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">P<%= "=" + coinm[2] %></div>
                                </div>
                                <div class="progress" style="height: 30px">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 100%; height: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"><%= fiat %>تومان</div>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <%--  <br />
                                  ...
                                  <div style="display:none;width:100%;height:90%;padding-bottom:50px">
           <telerik:RadHtmlChart runat="server" ID="PayDayChartBala" Width="85%" Height="100%" Skin="Silk">
            <PlotArea>
                <Series>
                    ...
                    <telerik:AreaSeries DataFieldY="DayP" Name="Expenses">
                        <Appearance>
                ...
                <XAxis DataLabelsField="Date" AxisCrossingValue="0" Color="White" MajorTickType="Outside" MinorTickType="Outside" Reversed="false">
                    <Items>
                    ...
                    <LabelsAppearance Color="White" DataFormatString="{0}" RotationAngle="0" Skip="0" Step="1">
                    </LabelsAppearance>
                </XAxis>
                <YAxis AxisCrossingValue="0" Color="white" MajorTickSize="4" MajorTickType="Outside"
            ...
            <ChartTitle Text="MTT performance">
