<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="UserHide.aspx.cs" Inherits="NM.Account.UserHide" %>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">مخفی کردن جایگاه!</h1>
                  <hr />
              </div>        
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                         <input name="UId" type="text" runat="server" class="form-control form-control-user"
                                 id="UId" placeholder="نام کاربری" required>
                    </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
                         <input name="BalaCode" type="text" runat="server" class="form-control form-control-user"
                                 id="BalaCode" placeholder="نام کاربری بالاسری" required>
                    </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <asp:Button runat="server" OnClick="Register_Click" ID="Register" class="btn btn-primary btn-user btn-block" Text="مخفی کردن جایگاه" />   
                        <asp:Button runat="server" OnClick="ShowTree_Click" ID="ShowTree" class="btn btn-primary btn-user btn-block" Text="نمایش ساختار درختی" />                        
