<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="FreePosition.aspx.cs" Inherits="NM.Account.FreePosition" %>
           ...
           BorderStyle="Inset" AllowSorting="True">
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridButtonColumn CommandName="FillLOAN" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlAltText="Filter column9 column" HeaderText="مبلغ" UniqueName="LOAN" DataTextField="TLoans" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridButtonColumn>
                       ...
                       <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="LoanAmt" type="number" runat="server" class="form-control form-control-user"
                                 id="LoanAmt" placeholder="مبلغ شارژ">
                        </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
