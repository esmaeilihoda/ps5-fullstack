...
<%--  <asp:UpdatePanel runat="server" ID="UP"><ContentTemplate>--%>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row" style="background-color:rgb(14 23 38);">
              <div class="col-lg-6 d-none d-lg-block bg-login-image"></div>
              <div class="col-lg-6">
                <div class="p-5" style="background-color:rgb(14 23 38);border-color:red;border-radius:25px;border-style:double">
 ...
 <%--   <telerik:RadFormDecorator RenderMode="Lightweight" ID="FormDecorator1" runat="server" DecoratedControls="All" DecorationZoneID="zoneToDecorate">
    ...
    <div class="demo-container" id="zoneToDecorate">
        ...
        </telerik:RadCaptcha><a href="Login.aspx"><img src="../img/loading.gif" /></a>
        ...
        <div style="margin-top: 15px;">
            <asp:Button CssClass="btn btn-primary btn-user btn-block" ID="btnValidate" runat="server" Text="ورود" ValidationGroup="Group">
                    ...
                    <a href="../index.aspx" class="btn btn-dark btn-user btn-block">
                     ...
                     <a href="Register.aspx" class="btn btn-info btn-user btn-block">
