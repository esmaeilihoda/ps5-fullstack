<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="CoinPercent.aspx.cs" Inherits="NM.Account.CoinPercent" %>
           ...
           BorderStyle="Inset" AllowSorting="True">
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridBoundColumn FilterControlAltText="Filter column9 column" CurrentFilterFunction="Contains" ShowFilterIcon="false" HeaderText="وام" UniqueName="SLOAN" DataField="SLOAN" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridBoundColumn>
                        <telerik:GridButtonColumn CommandName="TIncomes" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlAltText="Filter column9 column" HeaderText="درآمد" UniqueName="TIncomes" DataTextField="TIncoms" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridButtonColumn>
                        <telerik:GridButtonColumn CommandName="FillLOAN" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterControlAltText="Filter column9 column" HeaderText="%" UniqueName="LOAN" DataTextField="TLoans" HeaderTooltip="">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="BK" />
                            <ItemStyle ForeColor="#0066FF" Font-Underline="false" Font-Bold="true" Font-Size="Medium" HorizontalAlign="Center" BorderStyle="Outset" Font-Names="B Nazanin" />
                        </telerik:GridButtonColumn>
             ...
             <div runat="server" id="Div1" class="col-xl-9">
                  <div class="form-group row">
                         <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="UID" type="text" readonly="readonly" runat="server" class="form-control form-control-user"
                                 id="UID" placeholder="کد کاربری">
                        </div>
                       <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="UNAME" type="text" runat="server" class="form-control form-control-user"
                                 id="UNAME" placeholder="نام کاربری">
                        </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="LoanAmt" type="number" runat="server" class="form-control form-control-user"
                                 id="LoanAmt" placeholder="درصد کسر">
                        </div>
                      
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="MaxP" type="number" runat="server" class="form-control form-control-user"
                                 id="MaxP" placeholder="سقف را به ام تی تی کوین وارد کنید!">
                        </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <asp:Button runat="server" OnClick="Register_Click" ID="Register" class="btn btn-primary btn-user btn-block" Text="ثیت " />
                   </div>
                    </div>
             </div></div>
                 <%--OnNeedDataSource="Marketers_Grid_NeedDataSource" OnItemCommand="Marketers_Grid_ItemCommand"--%>   
