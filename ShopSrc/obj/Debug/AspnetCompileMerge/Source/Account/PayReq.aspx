<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="PayReq.aspx.cs" Inherits="NM.Account.PayReq" %>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">درخواست واریز وجه!</h1>
                  <hr />
              </div>        
