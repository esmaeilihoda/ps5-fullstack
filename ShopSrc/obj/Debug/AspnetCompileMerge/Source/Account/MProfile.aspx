<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="MProfile.aspx.cs" Inherits="NM.Account.MProfile" %>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input name="Fname" type="text" runat="server" class="form-control form-control-user"
                                 id="Fname" placeholder="نام خانوادگی" >
                        </div>
                    </div>
                   <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
              ...
              <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input name="varename" type="text" runat="server" class="form-control form-control-user"
                                 id="varename" placeholder="نام وارث" >
                        </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input name="varescode" type="text" runat="server" class="form-control form-control-user"
                                 id="varescode" placeholder="کد ملی وارث" >
                        </div>
                    </div>
                  <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input visible="false" name="companysign" type="text" runat="server" class="form-control form-control-user"
                                 id="companysign" placeholder="استفاده از امضای شرکت" >
...
<%--                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input name="shaba" type="text" runat="server" class="form-control form-control-user"
                                 id="shaba" placeholder="شماره شبا" >
                        </div>
                    </div>--%>
                     <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input name="Tell" type="text" runat="server" class="form-control form-control-user"
                                 id="Tell" placeholder="شماره موبایل" >
                        </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
