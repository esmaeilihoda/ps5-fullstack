<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Man.Master" AutoEventWireup="true" CodeBehind="InPay.aspx.cs" Inherits="NM.Account.InPay" %>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">نتیجه خرید پک سرمایه گذاری!</h1>
                  <hr />
              </div>        
