<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AdMan.Master" AutoEventWireup="true" CodeBehind="Tickets.aspx.cs" Inherits="NM.Account.Tickets" %>
         ...
         <div class="row">
          ...
          <telerik:RadGrid AllowPaging="true" PageSize="20" ClientSettings-AllowKeyboardNavigation="true" 
           ...
           BorderStyle="Inset" AllowSorting="True">
                ...
                <MasterTableView>
                    <Columns>
                        <telerik:GridButtonColumn CommandName="Confirm" FilterControlAltText="Filter column9 column" HeaderText="ارسال پاسخ"                                                 
