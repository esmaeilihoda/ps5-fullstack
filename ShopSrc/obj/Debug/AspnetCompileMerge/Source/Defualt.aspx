<%@ Page Title="" Language="C#" MasterPageFile="~/NMS.Master" AutoEventWireup="true" CodeBehind="Defualt.aspx.cs" Inherits="NM.Defualt" %>
                ...
                <div class="row">
                  <div class="col-md-8 col-md-offset-2">
                    <div class="home-content">
                      <a href="http://espadannet.com:2020/" >فروشگاه اینترنتی اسپادان</a>
					  <a style="margin-right:20px" href="Account/index.aspx">پنل کاربری</a>
                      <div class="home-heading">
                        <h1><em>پدید آوران</em> کار و ثروت اسپادان</h1>
                      </div>
                      <div class="row">
                        <div class="col-md-12">
                          <div class="home-box-content">
                            <div class="left-text">
                              <h4>پدیده <em>پدید آوران</em> پدیده ای جدید</h4>
                              <p>محلی برای اجرا کردن قانون وین وین برای همه ایرانیان عزیز</p>
            ...
            <div class="panel__content">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="footer">
                      <p> تمامی حقوق مادی و معنوی این وبسایت برای&copy; پدید آوران کار و ثروت اسپادان
                      | محفوظ است</p>
                    </div>
                  </div>
                </div>
