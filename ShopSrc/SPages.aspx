<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SPages.aspx.cs" Inherits="Shop.SPages" %>
...
<body style="background-color: rgb(1, 6, 34)">
    <form id="form1" runat="server">
        ...
        <footer class="my-5 text-center">
            ...
            <p class="mb-2"><small>کپی رایت © 2020 کلیه ی حقوق محفوظ CHECKIT است  </small></p>
